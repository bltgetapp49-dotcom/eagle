...
/**
 * Build a plain object from a Firestore doc for client responses.
 */
...
/**
 * API Route: `/api/track`
 * - GET: fetch a single shipment by `id` (public)
 * - PATCH: update shipment progress/status (admin only)
 */
